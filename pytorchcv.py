...
def load_mnist(batch_size=64):
    builtins.data_train = torchvision.datasets.MNIST('/Desktop/CodeFolder/PCS/dataset',
        download=True,train=True,transform=ToTensor())
    builtins.data_test = torchvision.datasets.MNIST('/Desktop/CodeFolder/PCS/dataset',
